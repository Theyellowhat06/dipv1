...
const Page: NextPageWithLayout = () => {
  ...
  const title = ['Гүйлгэний утга', 'Гүйлгээ хийгдсэн данс', 'Гүйлгэний дүн', 'Үлдэгдэл төлбөр']
  const fdata = [
    {
      label: 'Код',
      key: '',
  ...
  const tData = [
    [1,'CM22090101', '5048000154', '100000₮', <div className='flex justify-center items-center'>0₮</div>],
    [1,'CM22090101', '5048000154', '100000₮', <div className='flex justify-center items-center'>100000₮</div>],
    [1,'CM22090101', '5048000154', '100000₮', <div className='flex justify-center items-center'>200000₮</div>],
  ]
...
//   }
  ...
  return <div>
  <div className='text-xl pl-4 pb-2'>Төлбөрийн мэдээлэл</div>
